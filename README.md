...
### 리치 텍스트 편집
굵게·기울임·밑줄·취소선·글자색·형광펜·글자크기, 제목(1~6), 글머리표·번호·체크리스트, 인용문, 표, 이미지, 링크, 수평선, 접을 수 있는 세부 블록을 지원하는 툴바 기반 편집기입니다.

### 코드 블록
18개 언어에 대한 구문 강조를 지원하는 코드 블록을 삽입할 수 있습니다.

### 폴더·태그 정리
계층형 폴더와 다중 태그로 메모를 분류하고, 즐겨찾기와 최근 메모 보기를 제공합니다. 삭제한 메모는 휴지통에 보관되며 30일 후 자동 삭제됩니다.
